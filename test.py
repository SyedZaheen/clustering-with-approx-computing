from adders import error_report, first_batch_adders, second_batch_adders
...
error_report.plot_error_vs_inaccurate_bits(second_batch_adders.BPAA_LSP1_approx, 16, 102.123, 12452.123)
